...
def _revert_scenario_run_locked(request, run_id: int):
            ...
            with transaction.atomic():
                ...
                for idx, ev in enumerate(events):
                    ...
                    if target == "aircraft":
                        ...
                        status_val = (ev.get("status") or "").strip()
                        ...
                        if not status_val and not rtl and not remarks.strip() and not date_down:
                            return JsonResponse(
