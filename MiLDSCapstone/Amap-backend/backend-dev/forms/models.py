...
class EventTasks(models.Model):
    ...
    id = models.BigAutoField("Auto Unique ID", primary_key=True)
    event = models.ForeignKey("DA_7817", on_delete=models.CASCADE, db_column="da7817")
...
class DA_7817(models.Model):
    """
    Defines the DA Form 7817 - Aviation Maintainer Training Record
    """
    ...
    class Meta:
        db_table = "forms_da_7817"
        verbose_name = "DA 7817"
        verbose_name_plural = "DA 7817s"

    def __str__(self):
        return "DA 7817 record entered for {} {} {} on {}".format(
            self.soldier.rank,
