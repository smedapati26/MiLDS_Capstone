...
from forms.models import DA_4856, DA_7817, SupportingDocument
...
@tag("forms", "da_7817", "shiny_get_7817_associated_data")
class TestShinyGet7817AssociatedData(TestCase):
    ...
    def test_invalid_7817_id(self):
        # Make the request
        resp = self.client.get(reverse("shiny_7817_assoc_docs", kwargs={"da_7817_id": 51198}))
    ...
    def test_valid_no_associated_data(self):
        # Make the request
        resp = self.client.get(reverse("shiny_7817_assoc_docs", kwargs={"da_7817_id": self.event.id}))
