...
@tag("forms", "da_7817", "get_shiny_event_occurences")
class GetShinyEventOccurencesTests(TestCase):
    def setUp(self):
        ...
        self.soldier_1_eval_1: DA_7817 = create_single_test_event(
            soldier=self.soldier_1, recorded_by=self.soldier_2, uic=self.unit
        )
        self.soldier_1_eval_2: DA_7817 = create_single_test_event(
        ...
        self.soldier_1_train_1: DA_7817 = create_single_test_event(
            soldier=self.soldier_1,
            recorded_by=self.soldier_2,
            uic=self.unit,
        ...
        self.soldier_1_train_2: DA_7817 = create_single_test_event(
            soldier=self.soldier_1,
            recorded_by=self.soldier_2,
            uic=self.unit,
            event_type=create_test_event_type(event_type=OldEventType.Training.value),
        ...
        self.request_url = reverse("get_event_occurences")
