...
class Edit7817Tests(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.test_gaining_unit = create_test_unit(uic="TESTAA")
        # Create Soldier
    ...
    def test_edit_with_no_user_id_in_header(self):
        ...
        """
        url = reverse("shiny_edit_7817", kwargs={"da_7817_id": self.test_event.id})
    ...
    def test_edit_with_invalid_7817_id(self):
        ...
        """
        url = reverse("shiny_edit_7817", kwargs={"da_7817_id": 123123})
    ...
    def test_edit_PCS_event_via_http_put(self):
        ...
        self.assertTrue(DA_7817.objects.filter(id=self.test_event.id).exists())
