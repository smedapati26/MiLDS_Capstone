...
from forms.models import SupportingDocument, SupportingDocumentType, Soldier, DA_7817
...
def create_single_test_supporting_document(
    ...
    related_event: DA_7817 | None = None,
    ...
    @param related_event: (DA_7817 | None) The event relating to this Supporting Document
