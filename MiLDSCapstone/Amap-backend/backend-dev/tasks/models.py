...
from tasks.model_utils import SkillLevel, Proponent, unit_task_file_name
...
class Ictl(models.Model):
    ...
    proponent = models.CharField("Propenent", max_length=6, choices=Proponent.choices, null=True, blank=True)
    unit = models.ForeignKey("personnel.Unit", on_delete=models.CASCADE, null=True, blank=True)
