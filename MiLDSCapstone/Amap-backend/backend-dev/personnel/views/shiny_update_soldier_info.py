...
def shiny_update_soldier_info(request: HttpRequest, user_id: str):
    ...
    try:
        ...
        birth_month = request_body.get("birth_month", None)
        ...
        response_json = {
            ...
            "primary_mos": soldier.primary_mos.mos,
