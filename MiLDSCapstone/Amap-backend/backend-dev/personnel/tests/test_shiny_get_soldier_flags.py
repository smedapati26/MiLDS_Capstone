...
from utils.tests import create_test_soldier, create_test_unit, create_test_soldier_flag, create_user_role_in_all
...
class GetSoldierFlagsTestCase(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.second_unit = create_test_unit(uic="TEST000AB", short_name="2-100 TEST")
        ...
        self.first_flag = create_test_soldier_flag(last_modified_by=self.flag_recorder, soldier=self.soldier_1)
        self.second_flag = create_test_soldier_flag(last_modified_by=self.flag_recorder, soldier=self.soldier_2)
        ...
        self.inactive_flag = create_test_soldier_flag(
            last_modified_by=self.flag_recorder, soldier=self.soldier_1, start_date="2023-09-10", end_date="2023-10-01"
        )
