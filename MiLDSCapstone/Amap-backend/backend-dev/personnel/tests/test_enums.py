...
from personnel.model_utils import MosCode, Echelon, MaintenanceLevel, Rank
...
class EnumTestCase(TestCase):
    ...
    def test_enum_has_value__success(self):
        ...
        echelon = Echelon.has_value(Echelon.ARMY)
        self.assertTrue(echelon)
    ...
    def test_enum_has_value__fail_bool(self):
        ...
        echelon = Echelon.has_value(self.error_value)
        self.assertFalse(echelon)
    ...
    def test_enum_has_value__fail_error_message(self):
        ...
        error = Echelon.has_value(self.error_value, return_error=True)
        self.assertEqual(f"{self.error_value} not found in Echelons", error)
