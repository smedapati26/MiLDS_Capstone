...
def create_new_soldier(record: dict):
    ...
    Soldier.objects.create(
        ...
        unit=TRANSIENT,
        is_admin=False,
        is_maintainer=(mos.mos in mx_mos),
...
onboarding_unit = Unit.objects.get(uic="W8BAFF")
onboarding_unit_2 = Unit.objects.get(uic="W8BNFF")
onboarding_unit_3 = Unit.objects.get(uic="W8AKFF")
onboarding_unit_4 = Unit.objects.get(uic="W8A3FF")
onboarding_unit_5 = Unit.objects.get(uic="WYDJB0")
onboarding_unit_6 = Unit.objects.get(uic="W00YFF")
onboarding_unit_7 = Unit.objects.get(uic="W8A2FF")
onboarding_unit_8 = Unit.objects.get(uic="W8AJFF")
onboarding_unit_9 = Unit.objects.get(uic="W8AXFF")
onboarding_unit_10 = Unit.objects.get(uic="W8ALFF")
onboarding_unit_11 = Unit.objects.get(uic="W8A8FF")
onboarding_unit_12 = Unit.objects.get(uic="W8BTFF")


# exclude_unit = Unit.objects.get(short_name="1-25 ARB")
# exclude_second_unit = Unit.objects.get(uic="WJYVAA")
uics_onboarding_now = (
    ...
    # - set([exclude_second_unit, *exclude_second_unit.subordinate_uics])
)
