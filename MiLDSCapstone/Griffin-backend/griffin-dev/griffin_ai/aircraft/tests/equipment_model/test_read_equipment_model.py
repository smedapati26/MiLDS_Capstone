...
@tag("aircraft", "equipment_model", "read_equipment_model")
class TestReadEquipmentModel(TestCase):
    def setUp(self):
    ...
    def test_invalid_id(self):
        ...
        # Make the API call
        # -----------------
        resp = self.client.get(new_url, headers=self.request_headers)
    ...
    def test_valid_request(self):
        ...
        expected_data = {"name": self.equipment_model.name, "id": self.equipment_model.id}
