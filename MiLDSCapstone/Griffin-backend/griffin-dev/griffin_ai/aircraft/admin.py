...
@admin.register(AircraftTransferRequest)
class AircraftTransferRequestAdmin(admin.ModelAdmin):
    pass


@admin.register(AircraftTransferLog)
class AircraftTransferLogAdmin(admin.ModelAdmin):
    exclude = ["id"]
