...
from django.http import HttpRequest, HttpResponseServerError, JsonResponse, HttpResponseNotFound
    ...
    syncs = [
        {
            ...
            **{f"sync_{field}": aircraft.should_sync_field(field) for field in sync_fields}
        }
