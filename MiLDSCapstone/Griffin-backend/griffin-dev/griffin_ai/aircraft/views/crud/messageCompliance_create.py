...
from django.http import HttpRequest, HttpResponseNotFound, HttpResponseBadRequest, JsonResponse, HttpResponse
from django.views.decorators.http import require_http_methods
from http import HTTPStatus
import json

from aircraft.models import MessageCompliance, Message, Aircraft
