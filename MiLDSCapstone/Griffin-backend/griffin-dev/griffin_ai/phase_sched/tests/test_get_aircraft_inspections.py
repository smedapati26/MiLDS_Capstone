...
from utils.tests import create_single_test_unit, create_single_test_aircraft
...
class GetAircraftInspectionsTests(TestCase):
    ...
    def setUp(self):
        ...
        # # Blackhawk
        self.blackhawk = create_single_test_aircraft(self.unit, serial="BLACKHAWK", model="UH-60M")

        # Chinook
        self.chinook = create_single_test_aircraft(self.unit, serial="CHINOOK", model="CH-47FM3")

        # Apache
        self.apache = create_single_test_aircraft(self.unit, serial="APACHE", model="AH-64E")
