...
from aircraft.models import Aircraft, DA_1352
...
def update_1352s(records: pd.DataFrame, reporting_period: date):
    ...
    for serial_number, aircraft_info in records.iterrows():
        ...
        try:
            ...
            da_1352_record.flying_hours = max(aircraft.flight_hours, aircraft_info["Flying Hours"])
            ...
            da_1352_record = DA_1352(
                ...
                flying_hours=max(aircraft.flight_hours, aircraft_info["Flying Hours"]),
