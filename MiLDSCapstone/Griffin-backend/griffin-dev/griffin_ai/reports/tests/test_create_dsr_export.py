...
class CreateDSRExportTestCase(TestCase):
    ...
    def test_create_dsr_for_non_existant_unit(self):
        url = reverse("create_dsr_export", kwargs={"uic": "INVALID"})
    ...
    def test_create_dsr_with_incorrect_user_id(self):
        url = reverse("create_dsr_export", kwargs={"uic": self.units[0].uic})
    ...
    def test_create_dsr(self):
        ...
        response = self.client.post(url, data={"pages": ["summary", "details"]}, content_type="application/json")
