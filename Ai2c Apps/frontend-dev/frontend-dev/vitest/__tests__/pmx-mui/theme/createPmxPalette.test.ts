...
import { createPmxPalette } from '@pmx-mui-theme/createPmxPalette';
...
describe('createPmxPalette', () => {
  ...
  it('should create a dark mode palette', () => {
    ...
    expect(palette.graph).toBe(baseDarkPalette.graph);
    expect(palette.stacked_bars).toBe(baseDarkPalette.stacked_bars);
  ...
  it('should create a light mode palette', () => {
    ...
    expect(palette.graph).toBe(baseLightPalette.graph);
    expect(palette.stacked_bars).toBe(baseLightPalette.stacked_bars);
