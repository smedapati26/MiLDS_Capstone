...
import { DualDateRangePicker } from '@pmx-mui-components/DualDateRangePicker';
import { render, screen } from '@testing-library/react';

describe('DualDateRangePicker', () => {
  it('renders without crashing', () => {
    render(<DualDateRangePicker
...
describe('DualDateRangePicker Input Validation', () => {
  ...
  it('calls onDateRangeChange with valid dates', async () => {
  ...
  it('calls onDateRangeChange with invalid dates', async () => {
    const spy = vi.spyOn(onDateRangeChange, 'mockImplementation');
