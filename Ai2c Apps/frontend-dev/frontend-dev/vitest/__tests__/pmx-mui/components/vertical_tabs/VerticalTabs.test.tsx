...
import { VerticalTabPanel, verticalTabPanelA11yProps } from '@pmx-mui-components/vertical_tabs/VerticalTabPanel';
import { VerticalTabs } from '@pmx-mui-components/vertical_tabs/VerticalTabs';
