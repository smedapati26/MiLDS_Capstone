...
def create_object_transfer_request(request: HttpRequest):
    ...
    if requested_object_type == TransferObjectTypes.AIR:
        try:
            ...
            original_uic = requested_aircraft.current_unit
        ...
        try:
            ...
            original_uic = requested_uac.current_unit
        ...
        try:
            ...
            original_uic = requested_uav.current_unit
    ...
    creation_kwargs = {
        ...
        **{
            ...
            "originating_unit": original_uic,
            "originating_unit_approved": user_has_permissions_to(user, original_uic, UserRoleAccessLevel.ADMIN),
