...
@require_GET
def da_2407_export_page(request: HttpRequest):
    """
    Renders a simple DA2407 Export Upload Template useful for testing the uploader and
    ...
    return render(request, "auto_dsr/da2407_uploader.html", context)
