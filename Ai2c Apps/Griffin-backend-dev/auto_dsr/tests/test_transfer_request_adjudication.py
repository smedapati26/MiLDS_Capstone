...
class ManageAircraftTransferRequestApprovalTest(TestCase):
    ...
    def test_manage_transfer_request_adjudication_invalid_partents(self):
        # Update the request kwargs
        self.request_data["transfer_request_ids"] = [
            self.aircraft_transfer_request.id,
            self.uac_transfer_request.id,
        ...
        self.aircraft_transfer_request.originating_unit.parent_uics += [
            "XYZ987",
            "ABC654",
            "DEF213",
        ]
        self.aircraft_transfer_request.originating_unit.save()
        self.aircraft_transfer_request.destination_unit.parent_uics += [
            "ABC123",
            "DEF456",
        ]
        self.aircraft_transfer_request.destination_unit.save()
