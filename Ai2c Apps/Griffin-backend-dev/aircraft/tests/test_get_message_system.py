...
@tag("aircraft", "message", "get_message_system")
class GetMessageSystemTests(TestCase):
    def setUp(self):
        create_test_units()
    ...
    def test_get_message_system_with_invalid_unit_uic(self):
        # Make the API call
        response = self.client.get(reverse("get_message_system", kwargs={"unit_uic": "NOT" + self.top_unit.uic}))

        # Verify expected Response
        self.assertEqual(response.status_code, HTTPStatus.NOT_FOUND)
        self.assertEqual(response.content.decode("utf-8"), HTTP_ERROR_MESSAGE_UNIT_DOES_NOT_EXIST)

    def test_get_message_system_with_no_related_message_compliances(self):
        ...
        # Make the API call
        response = self.client.get(reverse("get_message_system", kwargs={"unit_uic": self.top_unit.uic}))
    ...
    def test_get_message_system_with_unit_having_no_sub_units(self):
        # Make the API call
        response = self.client.get(reverse("get_message_system", kwargs={"unit_uic": self.bottom_unit.uic}))

        # Set up expected data and response data
        expected_data = [
            {
                "message": self.aircraft_2_mc_2.message.number,
                "type": self.aircraft_2_mc_2.message.type,
                "classification": self.aircraft_2_mc_2.message.classification,
                "publication_date": str(self.aircraft_2_mc_2.message.publication_date),
                "compliance_date": self.aircraft_2_mc_2.message.compliance_date,
                "confirmation_date": self.aircraft_2_mc_2.message.confirmation_date,
                "contents": self.aircraft_2_mc_2.message.contents,
    ...
    def test_get_message_system_with_unit_having_sub_units(self):
        # Make the API call
        response = self.client.get(reverse("get_message_system", kwargs={"unit_uic": self.top_unit.uic}))
        ...
        expected_data = [
            {
                ...
                "type": self.aircraft_1_mc_1.message.type,
                "classification": self.aircraft_1_mc_1.message.classification,
                "publication_date": str(self.aircraft_1_mc_1.message.publication_date),
                "compliance_date": self.aircraft_1_mc_1.message.compliance_date,
                "confirmation_date": self.aircraft_1_mc_1.message.confirmation_date,
                "contents": self.aircraft_1_mc_1.message.contents,
            ...
            },
            {
                ...
                "type": self.aircraft_1_mc_2.message.type,
                "classification": self.aircraft_1_mc_2.message.classification,
                "publication_date": str(self.aircraft_1_mc_2.message.publication_date),
                "compliance_date": self.aircraft_1_mc_2.message.compliance_date,
                "confirmation_date": self.aircraft_1_mc_2.message.confirmation_date,
                "contents": self.aircraft_1_mc_2.message.contents,
