...
from utils.tests import create_single_test_unit, create_test_aircraft_in_all


@tag("aircraft")
class Get1352Test(TestCase):
    def setUp(self):
        """
        ...
        self.record_main = DA_1352.objects.create(
        ...
        self.record_sub = DA_1352.objects.create(
    ...
    def test_uic_filtering(self):
        ...
        url = reverse("get_1352", args=[self.unit.uic])
    ...
    def test_date_range_filtering(self):
        ...
        end_date = date.today()
        # Use Django's reverse function to construct the URL path for the function.
        url = reverse("get_1352", args=[self.unit.uic, start_date, end_date])
