...
def create_single_raw_test_sodlier(
    uic: str,
    dodid: str = "12345678",
    grade_rank: str = "E6",
...
def create_single_test_soldier(
    uic: Unit,
    dodid: str = "12345678",
    ...
    """
    rs = Soldier.objects.create(dodid=dodid, uic=uic, grade_rank=grade_rank, positions_posco=positions_posco, mos=mos)
