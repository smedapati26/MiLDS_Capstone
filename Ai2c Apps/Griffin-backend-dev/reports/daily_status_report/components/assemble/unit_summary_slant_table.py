...
from reports.daily_status_report.constants import QUARTER_INCH, SUMMARY_TABLE_FONT_SIZE, THREE_QUARTER_INCH


def assemble_slant_table(slant_df: pd.DataFrame) -> Table:
    """
