"""
griffin_ai settings for DSE Development Environment deployment
...
ALLOWED_HOSTS = [
    ...
    "griffin-backend-internal",
    "griffin-backend-internal.griffin.svc.cluster.local",
    ".army.mil",
    "172.19.2.136",
]
