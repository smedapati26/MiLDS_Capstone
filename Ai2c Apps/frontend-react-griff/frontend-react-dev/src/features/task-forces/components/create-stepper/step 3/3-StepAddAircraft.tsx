...
export const Step3AddAircraft: React.FC<Props> = ({ includeCreatePrompts = true }) => {
  // Form State
  ...
  const { tableData, rightData, leftData, handleOnTransfer, selectedSubordinate, setSelectedSubordinate } =
    useTableTransfer(data, 'aircraft');
  ...
  return (
    <Stack direction="column" gap={3}>
      ...
      <PmxTransferTable
        ...
        leftLabel="Aircraft Catalog"
        leftColumns={LEFT_COLUMNS}
        leftData={filteredData}
        rightLabel="Subordinates Aircraft"
