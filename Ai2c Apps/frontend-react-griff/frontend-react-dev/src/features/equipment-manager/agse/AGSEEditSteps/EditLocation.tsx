...
/**
 * A functional component that acts as a form for the Edit Location step in Multi Edit form.
 *
...
const EditLocationStep: FunctionComponent<Props> = (props: Props) => {
  ...
  return (
    <Box width="100%">
      <Typography sx={{ pt: 1, pb: 5 }}>Select a location to assign AGSE.</Typography>
      <LocationDropdown
        onChange={(e) => {
          setLocation(e);
        }}
