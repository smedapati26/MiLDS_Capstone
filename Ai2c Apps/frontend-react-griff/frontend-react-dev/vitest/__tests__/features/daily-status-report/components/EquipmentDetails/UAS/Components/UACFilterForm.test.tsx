...
import { UACFilterForm } from '@features/daily-status-report/components/EquipmentDetails/UAS/Components/UACFilterForm';
...
describe('UACFilterForm', () => {
  ...
  it('renders the filter form with default props', () => {
    renderWithProviders(<UACFilterForm tableData={[]} onApplyFilters={mockOnApplyFilters} />);
  ...
  it('calls useFilterOptions with correct parameters', () => {
    renderWithProviders(<UACFilterForm tableData={sampleTableData} onApplyFilters={mockOnApplyFilters} />);
