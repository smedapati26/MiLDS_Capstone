...
import EditLocationStep from '@features/equipment-manager/mods/ModEditSteps/EditLocation';
...
describe('EditLocationStep Test', () => {
  ...
  beforeEach(() => {
    render(<EditLocationStep location={mockLocation} setLocation={mockSetLocation} />);
  });
