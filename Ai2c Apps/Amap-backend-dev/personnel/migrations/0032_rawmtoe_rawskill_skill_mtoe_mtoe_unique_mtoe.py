# Generated by Django 4.2.4 on 2025-06-06 13:43
...
class Migration(migrations.Migration):
    dependencies = [
        ("units", "0001_initial"),
        ("personnel", "0031_alter_historicaluserrequest_access_level_and_more"),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("required_strength", models.IntegerField(blank=True, null=True, verbose_name="Required Strength")),
                ("authorized_strength", models.IntegerField(blank=True, null=True, verbose_name="Authorized Strength")),
                ("identity_code", models.CharField(blank=True, max_length=2, null=True, verbose_name="Identity Code")),
                ("position_code", models.CharField(blank=True, max_length=8, null=True, verbose_name="Position Code")),
                (
                    "army_mgmt_structure_code",
                ...
                ("asi_codes", models.ManyToManyField(related_name="mtoe_skills", to="personnel.skill")),
                (
                    "uic",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="unit_mtoes", to="units.unit"
                    ),
                ),
            ],
            options={
