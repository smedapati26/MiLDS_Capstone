...
from personnel.models import MOSCode, Soldier, SoldierAdditionalMOS, SoldierFlag
from personnel.utils import (
    get_prevailing_user_status,
    get_soldier_arrival_at_unit,
    get_soldier_designations,
...
class UserViews(View):
    ...
    def get(self, request: HttpRequest, user_id: str):
        ...
        user_details = {
            ...
            "designations": get_soldier_designations(requested_user),
            "eval_status": get_soldier_eval_status(requested_user)[2],
            "arrival_at_unit": get_soldier_arrival_at_unit(requested_user),
        }
