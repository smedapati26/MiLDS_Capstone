...
from utils.http.constants import CONTENT_TYPE_JSON, HTTP_404_SOLDIER_DOES_NOT_EXIST, HTTP_SUCCESS_STATUS_CODE
...
class GetSoldierDA7817s(TestCase):
    ...
    def test_get_soldier_da7817s(self):
        ...
        self.assertEqual(len(response_data), Event.objects.count() - 1)
