...
#     os.chdir("C:\\Users\\1036553100121004.MIL\\OneDrive - US Army\\Documents\\ICTLs\\New_ICTLs_03MAR25")
#     files = []
#     # Loop through ICTLs
...
#         if ictl_dict["proponent"] == "301":
#             proponent = Proponent.USAICOE
#         else:
...
# # Supercede old CTLs
# ids_to_supercede = [34, 36, 37, 47, 48, 49, 50, 435]

# ctls_to_supercede = Ictl.objects.filter(ictl_id__in=ids_to_supercede)

# for ctl in ctls_to_supercede:
#     ctl.status = "Superceded"
#     ctl.save()
