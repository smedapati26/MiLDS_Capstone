"""
amap settings for DSE Production Environment deployment
...
# TODO: STIG Compliance - V-222465 & V-222482
# Configure database logging to LAW only (no local DB logs)
# Add LOGGING configuration to send django.db.backends to Azure Monitor
# POAM 96 & 97 - Database call logging and centralized logging requirements
