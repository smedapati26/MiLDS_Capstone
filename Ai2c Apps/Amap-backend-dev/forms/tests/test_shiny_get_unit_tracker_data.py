...
from forms.models import EvaluationType, Event, EventTasks, EventType, TrainingType
...
class GetTrainAndEvalTrackingDataTests(TestCase):
    def setUp(self):
        ...
        self.unit_2 = create_testing_unit(uic="TEST000A0", parent_unit=self.unit)
        self.unit_3 = create_testing_unit(uic="TEST001AA")
        ...
        self.soldier_1_event_1: Event = create_single_test_event(
            soldier=self.soldier_1, recorded_by=self.soldier_1, uic=self.unit
        )
        self.soldier_1_event_2: Event = create_single_test_event(
        ...
        self.soldier_3_event_1: Event = create_single_test_event(
        ...
        expected_data = [
            {
                ...
                "MOS": self.soldier_1.primary_mos.mos,
            ...
            },
            {
                ...
                "MOS": self.soldier_2.primary_mos.mos,
            ...
            },
            {
                ...
                "MOS": self.soldier_3.primary_mos.mos,
