...
class AzureContainerStorage(Storage):
    ...
    def __init__(self, az_act_url: str | None = None, az_container: str | None = None):
    ...
    def _open(self, name: str, mode: str = "rb") -> File:
        ...
        with open("temp.pdf".format(name), "wb") as temp_file:
            temp_file.write(client.download_blob().readall())

        return File(open("temp.pdf", "rb"), name=name)
